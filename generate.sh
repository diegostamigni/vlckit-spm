...
TAG_VERSION="4.0.0a2"
IOS_URL="https://download.videolan.org/cocoapods/unstable/MobileVLCKit-4.0.0a2-b9e9412c-105babe3.tar.xz"
MACOS_URL="https://download.videolan.org/cocoapods/unstable/VLCKit-4.0.0a2-b9e9412c-105babe3.tar.xz"
TVOS_URL="https://download.videolan.org/cocoapods/unstable/TVVLCKit-4.0.0a2-b9e9412c-105babe3.tar.xz"
...
xcodebuild -create-xcframework \
    ...
    -framework "$IOS_LOCATION/ios-arm64_x86_64-simulator/MobileVLCKit.framework" \
    -debug-symbols "${PWD}/$IOS_LOCATION/ios-arm64_x86_64-simulator/dSYMs/MobileVLCKit.framework.dSYM" \
    -framework "$IOS_LOCATION/ios-arm64_armv7/MobileVLCKit.framework" \
    -debug-symbols "${PWD}/$IOS_LOCATION/ios-arm64_armv7/dSYMs/MobileVLCKit.framework.dSYM" \
...
PACKAGE_STRING="Target.binaryTarget(name: \"VLCKit-all\", url: \"https:\/\/github.com\/diegostamigni\/vlckit-spm\/releases\/download\/$TAG_VERSION\/VLCKit-all.xcframework.zip\", checksum: \"$PACKAGE_HASH\")"
